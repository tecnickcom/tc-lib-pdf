...
$html = <<<HTML
    ...
    <div class="page-break"></div>
    <h2>23) User Interface & Typography Properties</h2>
    <h3>font-size-adjust</h3>
    <p>Example for <code>font-size-adjust</code> with numeric and keyword values.</p>
    <style>
    .p6-wrap { border: 0.4pt solid #b0b9c4; background: #fafbfd; padding: 6pt; }
    .p6-row { border: 0.4pt solid #ccd4de; background: #fff; padding: 5pt; margin-bottom: 5pt; }
    .p6-label { font-size: 8pt; color: #56616f; margin-bottom: 2pt; }
    .fsa-none { font-size: 13pt; font-size-adjust: none; }
    .fsa-mid { font-size: 13pt; font-size-adjust: 0.58; }
    .fsa-high { font-size: 13pt; font-size-adjust: 0.72; }
    </style>
    <div class="p6-wrap">
      <div class="p6-row fsa-none">
        <div class="p6-label">font-size-adjust: none</div>
        Hamburgfonstiv 0123456789 - baseline sample for visual comparison.
      </div>
      <div class="p6-row fsa-mid">
        <div class="p6-label">font-size-adjust: 0.58</div>
        Hamburgfonstiv 0123456789 - should render without parser warnings.
      </div>
      <div class="p6-row fsa-high">
        <div class="p6-label">font-size-adjust: 0.72</div>
        Hamburgfonstiv 0123456789 - should render without parser warnings.
      </div>
      <p style="font-size:8pt; color:#666; margin:2pt 0 0 0;">
        Visual goal: all rows render cleanly; no style drop or malformed layout when numeric/none values are used.
      </p>
    </div>

    <h3>font-variant</h3>
    <p>Comparison between <code>font-variant: normal</code> and <code>font-variant: small-caps</code>.</p>
    <style>
    .fv-wrap { border: 0.4pt solid #b0b9c4; background: #fafbfd; padding: 6pt; }
    .fv-row { border: 0.4pt solid #ccd4de; background: #fff; padding: 5pt; margin-bottom: 5pt; font-size: 13pt; }
    .fv-label { font-size: 8pt; color: #56616f; margin-bottom: 2pt; }
    .fv-normal { font-variant: normal; }
    .fv-smallcaps { font-variant: small-caps; }
    </style>
    <div class="fv-wrap">
      <div class="fv-row fv-normal">
        <div class="fv-label">font-variant: normal</div>
        The quick brown fox jumps over the lazy dog.
      </div>
      <div class="fv-row fv-smallcaps">
        <div class="fv-label">font-variant: small-caps</div>
        The quick brown fox jumps over the lazy dog.
      </div>
      <p style="font-size:8pt; color:#666; margin:2pt 0 0 0;">
        Visual goal: both rows render correctly; small-caps effect may depend on font capabilities.
      </p>
    </div>

    <h3>quotes</h3>
    <p>Example for <code>quotes</code> using custom quote pairs and pseudo content.</p>
    <style>
    .qt-wrap { border: 0.4pt solid #b0b9c4; background: #fafbfd; padding: 6pt; }
    .qt-row { border: 0.4pt solid #ccd4de; background: #fff; padding: 5pt; margin-bottom: 5pt; }
    .qt-label { font-size: 8pt; color: #56616f; margin-bottom: 2pt; }
    .qt-default { quotes: auto; }
    .qt-custom { quotes: "\\00003C\\00003C" "\\00003E\\00003E" "\\00003C" "\\00003E"; }
    .qt-none { quotes: none; }
    .qt-mark::before { content: open-quote; }
    .qt-mark::after { content: close-quote; }
    </style>
    <div class="qt-wrap">
      <div class="qt-row qt-default">
        <div class="qt-label">quotes: auto</div>
        <span class="qt-mark">Quoted sample with default quotes</span>
      </div>
      <div class="qt-row qt-custom">
        <div class="qt-label">quotes: "&lt;&lt;" "&gt;&gt;" "&lt;" "&gt;"</div>
        <span class="qt-mark">Quoted sample with custom pair</span>
      </div>
      <div class="qt-row qt-none">
        <div class="qt-label">quotes: none</div>
        <span class="qt-mark">Quoted sample with quote suppression</span>
      </div>
      <p style="font-size:8pt; color:#666; margin:2pt 0 0 0;">
        Visual goal: content remains stable; quote glyph changes depend on current pseudo-content handling.
      </p>
    </div>
    ...
    <style>
    .ow-wrap { border: 0.4pt solid #b0b9c4; background: #fafbfd; padding: 6pt; }
    .ow-col { width: 78mm; display: inline-block; vertical-align: top; border: 0.4pt solid #ccd4de; background: #fff; padding: 5pt; }
    .ow-col + .ow-col { margin-left: 3mm; }
    .orphans-two { orphans: 2; }
    .orphans-six { orphans: 6; }
    </style>
    <div class="ow-wrap">
      <div class="ow-col orphans-two">
        <strong style="font-size:9pt;">orphans: 2</strong>
        <p style="margin:3pt 0 0 0;">
          Long paragraph sample used to inspect page-flow handling around breaks. Long paragraph sample used to inspect
          page-flow handling around breaks. Long paragraph sample used to inspect page-flow handling around breaks.
          Long paragraph sample used to inspect page-flow handling around breaks.
        </p>
      </div>
      <div class="ow-col orphans-six">
        <strong style="font-size:9pt;">orphans: 6</strong>
        <p style="margin:3pt 0 0 0;">
          Long paragraph sample used to inspect page-flow handling around breaks. Long paragraph sample used to inspect
          page-flow handling around breaks. Long paragraph sample used to inspect page-flow handling around breaks.
          Long paragraph sample used to inspect page-flow handling around breaks.
      ...
      <p style="font-size:8pt; color:#666; margin:4pt 0 0 0;">
        Visual goal: both blocks render identically and cleanly..
      </p>
    </div>
    <div style="padding-top:170mm;"></div>
    <div class="ow-wrap">
      <div class="ow-col orphans-two">
        <strong style="font-size:9pt;">orphans: 2</strong>
        <p style="margin:3pt 0 0 0;">
    ...
    <div class="page-break"></div>
    <h3>widows</h3>
    <p>Example of <code>widows</code>: Sets the minimum number of lines in a block container that must be left at the top of a new page or column.</p>
    <style>
    .wd-wrap { border: 0.4pt solid #b0b9c4; background: #fafbfd; padding: 6pt; }
    .wd-col { width: 78mm; display: inline-block; vertical-align: top; border: 0.4pt solid #ccd4de; background: #fff; padding: 5pt; }
    .wd-col + .wd-col { margin-left: 3mm; }
    .widows-two { widows: 2; }
    .widows-six { widows: 6; }
    </style>
    <div class="wd-wrap">
      <div class="wd-col widows-two">
        <strong style="font-size:9pt;">widows: 2</strong>
        <p style="margin:3pt 0 0 0;">
          Continuation paragraph sample for widow control checks near page boundaries. Continuation paragraph sample for
          widow control checks near page boundaries. Continuation paragraph sample for widow control checks near page
          boundaries. Continuation paragraph sample for widow control checks near page boundaries.
        </p>
      </div>
      <div class="wd-col widows-six">
        <strong style="font-size:9pt;">widows: 6</strong>
        <p style="margin:3pt 0 0 0;">
          Continuation paragraph sample for widow control checks near page boundaries. Continuation paragraph sample for
          widow control checks near page boundaries. Continuation paragraph sample for widow control checks near page
          boundaries. Continuation paragraph sample for widow control checks near page boundaries.
      ...
      <p style="font-size:8pt; color:#666; margin:4pt 0 0 0;">
        Visual goal: clean render with no style loss.
      </p>
    </div>
    <div style="padding-top:190mm;"></div>
    <div class="wd-wrap">
      <div class="wd-col widows-two">
        <strong style="font-size:9pt;">widows: 2</strong>
        <p style="margin:3pt 0 0 0;">
    ...
    <div class="page-break"></div>
    <h3>page</h3>
    <p>Example of named and keyword <code>page</code> values.</p>
    <style>
    .pg-wrap { border: 0.4pt solid #b0b9c4; background: #fafbfd; padding: 6pt; }
    .pg-row { border: 0.4pt solid #ccd4de; background: #fff; padding: 5pt; margin-bottom: 5pt; }
    .pg-auto { page: auto; }
    .pg-chapter { page: chapter; }
    .pg-appendix { page: appendix; }
    </style>
    <div class="pg-wrap">
      <div class="pg-row pg-auto"><strong>page: auto</strong> - baseline named-page behavior.</div>
      <div class="pg-row pg-chapter"><strong>page: chapter</strong> - named page token accepted.</div>
      <div class="pg-row pg-appendix"><strong>page: appendix</strong> - additional named page token accepted.</div>
      <p style="font-size:8pt; color:#666; margin:2pt 0 0 0;">
