...
$pdf->setPDFFilename('032_example_html_lists.pdf');
...
<div class="panel">
  ...
  <ol class="ol-decimal indent-first marker-guide">
    <li>First-line indent with long text to make wrapping visible in the list-item rendering path.</li>
