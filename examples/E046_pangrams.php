...
$html .= '<div style="text-align:right">صِف خَلقَ خَودِكِ كَمِثلِ الشَّمسِ إِذ بَزَغَت — يَحظى الضَّجيعُ بِها نَجلاءَ مِعطارِ</div>';
...
$html .= '<p>เป็นมนุษย์สุดประเสริฐเลิศคุณค่า กว่าบรรดาฝูงสัตว์เดรัจฉาน จงฝ่าฟันพัฒนาวิชาการ อย่าล้างผลาญฤๅเข่นฆ่าบีฑาใคร</p>';
...
$html .= '<p>いろはにほへと ちりぬるを わかよたれそ つねならむ うゐのおくやま けふこえて あさきゆめみし ゑひもせす</p>';
