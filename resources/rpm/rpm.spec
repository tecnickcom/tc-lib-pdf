...
Requires:  php-composer(%{c_vendor}/tc-lib-barcode >= 1.15.20
...
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-image >= 1.2.11
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-font) < 2.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-font >= 1.8.7
...
Requires:  php-composer(%{c_vendor}/tc-lib-unicode >= 1.3.11
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-page) < 3.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-page >= 2.4.10
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-graph) < 2.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-graph >= 1.4.11
