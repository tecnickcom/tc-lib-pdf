...
Requires:  php-composer(%{c_vendor}/tc-lib-barcode) >= 1.17.11
...
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-image) >= 1.3.7
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-font) < 2.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-font) >= 1.9.6
...
Requires:  php-composer(%{c_vendor}/tc-lib-unicode-data) >= 1.7.6
Requires:  php-composer(%{c_vendor}/tc-lib-unicode) < 2.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-unicode) >= 1.4.7
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-page) < 3.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-page) >= 2.5.6
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-graph) < 2.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-graph) >= 1.5.6
