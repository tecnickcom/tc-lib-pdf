...
Requires:  php-composer(%{c_vendor}/tc-lib-unicode-data) >= 2.6.1
Requires:  php-composer(%{c_vendor}/tc-lib-unicode) < 3.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-unicode) >= 2.10.1
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-page) < 5.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-page) >= 4.13.1
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-graph) < 3.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-graph) >= 2.14.1
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-parser) < 4.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-parser) >= 3.13.1
