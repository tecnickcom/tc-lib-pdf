...
Requires:  php-composer(%{c_vendor}/tc-lib-barcode >= 1.15.5
...
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-image >= 1.2.2
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-font) < 2.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-font >= 1.7.4
...
Requires:  php-composer(%{c_vendor}/tc-lib-unicode >= 1.3.4
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-page) < 3.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-page >= 2.4.1
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-graph) < 2.0.0
Requires:  php-composer(%{c_vendor}/tc-lib-pdf-graph >= 1.4.3
